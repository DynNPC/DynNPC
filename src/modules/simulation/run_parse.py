...
class Runner(object):
    ...
    def __init__(self, scenario_env_json, output_path, scenarioType, total_sim_time, default_record_folder, data_prime, lgsvl_map = 'SanFrancisco_correct', apollo_map = 'SanFrancisco_correct'):
        self.global_id = 0
        ...
        self.sim = Simulator(self.scenarioType, self.default_record_folder, self.record_path, total_sim_time, data_prime, self.status_path, self.collision_path, lgsvl_map, apollo_map) # save record to records/scenario_name/scenario_id
    ...
    def run(self, scenario_data):
        ...
        return float(sim_result.get('fitness', 100)), scenario_id
