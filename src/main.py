...
class Fuzzer(object):
    ...
    def __init__(self, cfgs):
        ...
        self.mutation_runner = GeneticMutator(self.runner, self.cfgs["scenario"], self.cfgs['selection'], self.output_path, self.scenario_name, cfgs['bounds'], cfgs['p_mutation'], cfgs['p_crossover'], cfgs['pop_size'], cfgs['npc_size'], cfgs['time_size'], cfgs['max_gen'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, help='Test config yaml file.', default='/mnt/sda/AdvFuzz/src/configs/config_int.yaml')
